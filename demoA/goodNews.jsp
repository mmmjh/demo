                  ...
                  <ul aria-labelledby="notifications" class="dropdown-menu">
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        ...
                        <div class="msg-body">
                          ...
                          <h3 class="h5"><%=userget.getUsername() %></h3><span>给你发来了一条信息</span>
                        </div></a></li>
                  </ul>
                </li>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center" style="margin-top:-30px;height:50px">
                      <h3 class="h4" >正面信息中心</h3>
                    </div>
                    <div class="card-body" style="margin-top:-20px">
						<% 
						request.setCharacterEncoding("UTF-8");
					//	String sqlGood= request.getParameter("aa");//sql语句
					String sqlGood=(String)session.getAttribute("sqlGood");
						List<WYNews> wynew=WYNewsDaoImpl.load(sqlGood);
						%>
